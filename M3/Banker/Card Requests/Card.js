const AcceptBR = () => {
    ...
    if (!client0) {
        alert ("You have to choose a Card request")
      return
    }     
  ...
  const AcceptBL = () => {
    ...
    if (!client2) {
      ...
      return
        ...
        document.getElementById('AAl').innerText = 'Client "Clara" with ID "125882522" Card request is accepted' 
      }
    ...
    if (!client3) {
      ...
      return
        ...
        document.getElementById('RAl').innerText = 'Client "Nada" with ID "252132455" Card request is Rejected' 
      }
